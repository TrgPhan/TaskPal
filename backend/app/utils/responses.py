...
def api_response(success: bool = True, data: Any = None, message: str = "", 
                status_code: int = 200, errors: Optional[Dict] = None) -> tuple:
...
def error_response(message: str = "An error occurred", status_code: int = 400, 
    ...
    return api_response(success=False, data=None, message=message, 
                       status_code=status_code, errors=errors)
...
# Specific status responses using success_response
